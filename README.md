...
本项目要求 **Node.js v22.x** 版本。

**推荐版本:** v22.20.0

**为什么需要特定版本？**
- `node-pty` 模块需要针对特定 Node.js 版本编译
- Electron 桌面应用内置 Node.js v24.11.1
- 开发环境使用 v22.x 可以确保最佳兼容性
...
访问 [Node.js 官网](https://nodejs.org/) 下载 v22.20.0 版本
...
#### Q: 如何自动使用正确的 Node.js 版本？

项目根目录包含 `.nvmrc` 文件，使用 nvm 时会自动切换版本：
