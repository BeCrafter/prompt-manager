...
import { SkillsUploadModal } from './SkillsUploadModal.js';
import { DeleteSkillModal } from './DeleteSkillModal.js';
import { ExportSkillModal } from './ExportSkillModal.js';
import { SkillSyncModal } from './SkillSyncModal.js';
...
export class SkillsArea {
        ...
        <div class="skills-sidebar">
          <div class="skill-sidebar-header">
            ...
            <div class="skill-sidebar-list">
              <div class="skill-sidebar-list-title-row">
                <div class="skill-sidebar-list-title" id="skillsCount">我的技能清单 (0)</div>
                <button class="icon-btn-small" id="skillSyncConfigBtn" title="同步设置">
                  ${ICONS.Settings}
                </button>
              </div>
  ...
  static bindEvents() {
    ...
    // 同步配置按钮
    const syncConfigBtn = document.getElementById('skillSyncConfigBtn');
    if (syncConfigBtn) {
      syncConfigBtn.onclick = (e) => {
        e.preventDefault();
        e.stopPropagation();
        SkillSyncModal.show();
      };
